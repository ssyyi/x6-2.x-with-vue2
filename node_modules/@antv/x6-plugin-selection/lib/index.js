...
require("./api");
class Selection extends x6_1.Basecoat {
    ...
    constructor(options = {}) {
        ...
        this.options = x6_1.ObjectExt.merge({ enabled: true }, Selection.defaultOptions, options);
    ...
    allowRubberband(e, strict) {
        return (!this.rubberbandDisabled &&
            x6_1.ModifierKey.isMatch(e, this.options.modifiers, strict));
    }
    allowMultipleSelection(e) {
        return (this.isMultiple() &&
            x6_1.ModifierKey.isMatch(e, this.options.multipleSelectionModifiers));
    }
