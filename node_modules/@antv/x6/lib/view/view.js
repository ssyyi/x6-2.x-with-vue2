...
class View extends x6_common_1.Basecoat {
    get priority() {
        return 2;
    }
    constructor() {
    ...
    addClass(className, elem = this.container) {
        x6_common_1.Dom.addClass(elem, Array.isArray(className) ? className.join(' ') : className);
        return this;
    }
    removeClass(className, elem = this.container) {
        x6_common_1.Dom.removeClass(elem, Array.isArray(className) ? className.join(' ') : className);
        return this;
    }
    setStyle(style, elem = this.container) {
        x6_common_1.Dom.css(elem, style);
        return this;
    }
    setAttrs(attrs, elem = this.container) {
        if (attrs != null && elem != null) {
            x6_common_1.Dom.attr(elem, attrs);
        }
        return this;
    }
    /**
    ...
    prefixClassName(className) {
        return config_1.Config.prefix(className);
    }
    ...
    undelegateEvents() {
        x6_common_1.Dom.Event.off(this.container, this.getEventNamespace());
        return this;
    }
    ...
    delegateEvent(eventName, selector, listener) {
        x6_common_1.Dom.Event.on(this.container, eventName + this.getEventNamespace(), selector, listener);
        return this;
    }
    undelegateEvent(eventName, selector, listener) {
        const name = eventName + this.getEventNamespace();
        if (selector == null) {
            x6_common_1.Dom.Event.off(this.container, name);
        }
        else if (typeof selector === 'string') {
            x6_common_1.Dom.Event.off(this.container, name, selector, listener);
        }
        else {
            x6_common_1.Dom.Event.off(this.container, name, selector);
        }
        return this;
    }
    addEventListeners(elem, events, data) {
        ...
        Object.keys(events).forEach((eventName) => {
            ...
            if (typeof method === 'function') {
                x6_common_1.Dom.Event.on(elem, eventName + ns, data, method);
            }
        });
        return this;
    }
    removeEventListeners(elem) {
        if (elem != null) {
            x6_common_1.Dom.Event.off(elem, this.getEventNamespace());
        }
        return this;
    }
    getEventNamespace() {
        return `.${config_1.Config.prefixCls}-event-${this.cid}`;
    }
